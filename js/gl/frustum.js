var Frustum = function(ctx) {
    this.ctx = ctx;
    this.clip = new Array(16);
...
Frustum.prototype.extractFrustum = function() {
    var mMat = this.ctx.matrix.mvMatrix;
    var pMat = this.ctx.matrix.pMatrix;
    var t;
...
Frustum.prototype.inFrustum = function(v1, v2) {
    for(var p = 0; p < 6; p++) {
